...
def read_excel_data_toclassin(filename, rowstart, rowend):
    ...
    for col in col_range:  # 打印 2-5行中所有单元格中的值
        ...
        import requests
        # YDD --->Mini班
        url = f"https://erp.test.klxuexi.net/erp/syncMtErpData2MtSystem/syncCourseInfo?isMtCourse=N&courseId=100186974"
...
if __name__ == '__main__':
    read_excel_data_toclassin(r"20200610厦门培英课程增加课次.xlsx", 2, 4)
