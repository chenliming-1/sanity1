...
def read_excel_data_toclassin(filename, rowstart, rowend):
    ...
    for col in col_range:  # 打印 2-5行中所有单元格中的值
        ...
        import requests
        # YDD --->Mini班
        url = f"https://erp.histudy.com//erp/syncMtErpData2MtSystem/syncCourseInfo?isMtCourse=N&courseId={course_id}"
...
if __name__ == '__main__':
    read_excel_data_toclassin(r"个性化小学堂课程处理数据.xlsx", 2, 174)
